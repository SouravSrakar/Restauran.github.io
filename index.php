       ...
       <!-- ============ Our Bread  ============= -->
        ...
        <section id="bread" class=" description_content">
            <div  class="bread background_content">
                <h1>Our Breakfast <a href="website-8/index.php">Menu</a></h1>
            </div>
            <div class="text-content container"> 
                <div class="col-md-6">
                    <h1>OUR BREAD</h1>
        ...
        <section id="featured" class="description_content">
            <div  class="featured background_content">
                <h1>Our Featured Dishes <a href="website-8/index.php">Menu</a></h1>
            </div>
            <div class="text-content container"> 
                <div class="col-md-6">
            ...
            <div class="text-content container"> 
                <div class="col-md-6">
                    ...
                    <ul class="social_icons">
                        <li><a class="icon-twitter color_animation" href="https://x.com/SouravSark95200?t=DxjJYJcQHOnYKbQHNBm6hA&s=08" target="_blank"></a></li>
                        <li><a class="icon-github color_animation" href="https://github.com/SouravSrakar" target="_blank"></a></li>
                        <li><a class="icon-linkedin color_animation" href="https://www.linkedin.com/in/sourav-sarkar-003064208/" target="_blank"></a></li>
                        <li><a class="icon-mail color_animation" href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox"></a></li>
                        
                    </ul>
                </div>
                <div class="col-md-4">
                    <span class="social_heading">OR DIAL</span>
                    <span class="social_info"><a class="color_animation" href="tel:7318979022">(+91) 731-897-9022</a></span>
                </div>
            </div>
        </section>
        ...
        <section id="contact">
            <div class="map">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29579.304542943413!2d87.31937850813304!3d22.072036531162286!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a1d3a57e6487717%3A0x6d8cdcc5fe4c571e!2sBelda%2C%20West%20Bengal!5e0!3m2!1sen!2sin!4v1699467053558!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen loading="lazy"></iframe>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="inner contact">
                            ...
                            <div class="contact-form">
                                ...
                                <form id="contact-us" method="post" action="contact.php">
                                    ...
                                    <div class="col-md-6">
    <!-- Name -->
    <input type="text" name="name" id="name" required="required" class="form" placeholder="Name" <?php if (empty($_SESSION['ses_user'])) echo 'disabled'; ?> />
    <!-- Email -->
    <input type="email" name="email" id="email" required="required" class="form" placeholder="Email" <?php if (empty($_SESSION['ses_user'])) echo 'disabled'; ?> />
    <!-- Phone Number -->
    <input type="text" name="phone" id="phone" required="required" class="form" placeholder="Phone Number" <?php if (empty($_SESSION['ses_user'])) echo 'disabled'; ?> />
</div><!-- End Left Inputs -->

                                    <!-- Right Inputs -->
                                    <div class="col-md-6">
                                        <!-- Message -->
                                        <textarea name="message" id="message" class="form textarea"  placeholder="Message"<?php if (empty($_SESSION['ses_user'])) echo 'disabled'; ?> ></textarea>
        ...
        <footer class="sub_footer">
            <div class="container">
                <div class="col-md-4"><p class="sub-footer-text text-center">&copy; Restaurant 2023, Theme by <a href="https://sourav9647.000webhostapp.com/">Sourav Sarkar</a></p></div>
                <div class="col-md-4"><p class="sub-footer-text text-center">Back to <a href="#top">TOP</a></p>
                </div>
                <div class="col-md-4"><p class="sub-footer-text text-center">Built With Care By <a href="#" target="_blank">India</a></p></div>
            </div>
        </footer>
